...
SECRET_KEY = '$#-=9joyx5uk_xo@ozepu4z$%d@85)j!!gfu1p$g3uz+p8*a!*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            path.join(BASE_DIR, 'miniproject', 'templates'),
        ],
        'OPTIONS': {
            'loaders': [
...
STATICFILES_DIRS = (
    path.join(BASE_DIR, 'miniproject', 'static'),
)
